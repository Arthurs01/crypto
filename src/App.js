//useEffect:  permite ejecutar la funcion al cargar el componente
//useState: permite definir una variable y luego da una función para actualizar esa variable 
...
const getData = async () =>{
  ...
  console.log(res.data)  //res.data = arreglo con 100 elementos 
  setCoins(res.data)
